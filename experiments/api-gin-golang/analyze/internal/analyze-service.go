...
func collectSysServices(user string, host string, privateKeyPath string) (string, error) {
	...
	client := connect_ssh(user, host, "22", privateKeyPath)
...
func parseSysServices(output []string) []Service {
...
func saveSysServices(services []Service, path string) (string, error) {
...
func parseExposedPorts(output []string) []Port {
	var ports []Port
...
func saveExposedPorts(ports []Port, path string) (string, error) {
